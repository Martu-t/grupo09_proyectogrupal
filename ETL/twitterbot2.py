...
def tweet_alerta1():
    ...
    for i in range(len(df1)):
        ...
        alerta_verde = f'{green} ¿Lo sentiste? No estás loco/a! Sismo leve a {dist} km de {ciudad}. Tranqui. La tierra {mundo} solo se está acomodando {ginio}'
...
def tweet_alerta2():
    ...
    for i in range(len(df2)):
        ...
        alerta_naranja = f'{alert} Sismo medio a {dist} km de {ciudad}. Manejo de vehículos {auto} es inseguro, Podés tener dificultad de quedarte en pie{caminar}. Alejarse de muebles y ventanas. Ya pasará.'
...
def tweet_alerta3():
    ...
    for i in range(len(df3)):
        ...
        alerta_roja = f'{alerta} Alerta máxima. Sismo grande a {dist} de {ciudad}. Importante agacharse y cubrirse. Cuidado con las estructuras {casa}. Algunos servicios sin funcionamiento. Posibles réplicas{ojos}'
