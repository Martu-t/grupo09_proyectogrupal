...
def twitter_csv():
    ...
    r0 = 3.5 # mag limit for row 0
    r1 = 5.5 # mag limit for row 1
    r2 = 7.5 # mag limit for row 2

    big_city = 20 # Population limit [thousand habitants]
    ...
    plus = 0.1
    max_lat = -17.483 + plus
    min_lat = -56.5366 - plus
    max_lon = -66.4233 + plus
    min_lon = -109.45833 - plus
